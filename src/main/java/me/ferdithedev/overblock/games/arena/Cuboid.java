...
public class Cuboid {
    ...
    public Location getRandomSolidLocation() {
    ...
    public boolean isIn(final Location loc) {
        return Objects.equals(loc.getWorld(), this.world) && loc.getBlockX() >= this.xMin && loc.getBlockX() <= this.xMax && loc.getBlockY() >= this.yMin && loc.getBlockY() <= this.yMax && loc
    ...
    public boolean isInWithMarge(final Location loc, final double marge) {
        return Objects.equals(loc.getWorld(), this.world) && loc.getX() >= this.xMinCentered - marge && loc.getX() <= this.xMaxCentered + marge && loc.getY() >= this.yMinCentered - marge && loc
